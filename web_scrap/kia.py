...
def get_car_urls(start_page, end_page):
    ...
    for page_num in range(start_page, end_page + 1):
        try:
            base_url = f'https://www.automobile.tn/fr/occasion/s=brand%21%3Akia/{page_num}'
...
def save_to_csv(start_page, end_page, filename='kia.csv'):
